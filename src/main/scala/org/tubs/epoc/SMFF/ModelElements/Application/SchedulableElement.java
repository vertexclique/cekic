...
public abstract class SchedulableElement extends ExtendibleModelElement<AbstractSchedElemData> implements Cloneable {
  ...
  /**
   * Best-case response time for this task.
   */
  protected double bcrt;
  
	/**
	 * Worst-case response time for this task.
	 */
	protected double wcrt;
	
  /**
   * input timing behavior for this schedulable element.
   */
  protected AbstractTimingBehavior inputBehavior = null;
  
	/**
	 * Output timing behavior for this schedulable element.
	 */
  ...
  protected Profile activeProfile;
    ...
    clone.inputBehavior = (AbstractTimingBehavior) inputBehavior.clone();
  ...
  /**
   * Returns the current best-case response time of this schedulable element.
   * 
   * @return response time of this task
   */
  public final double getBCRT() {
    return this.bcrt;
  }

  /**
   * Sets the best-case response time for this element.
   * 
   * @param wcrt
   *          the response time to set
   */
  public final void setBCRT(double bcrt) {
    this.bcrt = bcrt;
  }

  /**
   * Returns the current worst-case response time of this schedulable element.
   * 
   * @return response time of this task
   */
  public final double getWCRT() {
    return this.wcrt;
  }
	 ...
	 * 
	 * @return response time of this task
	 * @deprecated this function has been renamed to getWCRT() as now also a function getBCRT exists;
	 */
  ...
  /**
   * Sets the worst-case response time for this element.
   * 
   * @param wcrt
   *          the response time to set
   */
  public final void setWCRT(double wcrt) {
    this.wcrt = wcrt;
  }
	 ...
	 * @param wcrt
	 *          the response time to set
   * @deprecated this function has been renamed to setWCRT() as now also a function setBCRT exists;
	 */
	public final void setResponseTime(double responseTime) {
		this.setWCRT(responseTime);
	}

	/**
	 * Getter method for the input timing behavior of this element.
	 * 
	 * @return timing behavior at the output of this element
	 */
	public final AbstractTimingBehavior getInputBehavior() {
		return inputBehavior;
	}

	/**
	 * Setter method for the input timing behavior of this element.
	 * 
	 * @param outputBehavior
	 *          timing behavior at the output of this element
	 */
	public final void setInputBehavior(AbstractTimingBehavior inputBehavior) {
		this.inputBehavior = inputBehavior;
	}

  /**
   * Getter method for the output timing behavior of this element.
   * 
   * @return timing behavior at the output of this element
   */
  ...
  /**
   * Setter method for the outputtiming behavior of this element.
   * 
   * @param outputBehavior
   *          timing behavior at the output of this element
   */
  public final void setOutputBehavior(AbstractTimingBehavior outputBehavior) {
	...
	// */
	// @Override
	// public void addExtData(AbstractSchedElemData data, boolean clone) throws IllegalArgumentException {
	// super.addExtData(data, clone);
	// }
	//
	// /**
	// * Adds a data object to this task
	...
	// * @throws IllegalArgumentException if an object with the same identifier is already attached to this task
	// */
	// public void addExtData(AbstractSchedElemData data, boolean clone, boolean overwrite, boolean ignoreExisting) throws
	// IllegalArgumentException {
	// // if no list for this type exists, create it and get the list
	// if(!dataObjects.containsKey(data.getClass())){
	// dataObjects.put(data.getClass(), new LinkedList<AbstractSchedElemData>());
	// }
	// LinkedList<AbstractSchedElemData> list = dataObjects.get(data.getClass());
	//
  ...
  public void setBCET(int BCET) {
	...
	public final ElementLatencyConstraint isFeasible() {
		...
		for (ElementLatencyConstraint currentConstr : constrCollect) {
			if (currentConstr.getPathLatency() > currentConstr.getLatencyConstr()) {
				// if a constraint is broken sortList needs to be rearranged starting from this task
	 ...
	 */
	public ElementLatencyConstraint addConstraint(SchedulableElement predecessor, SchedulableElement successor,
	    int latency, SysLatencyConstraint sysLatency, Path path) {
		ElementLatencyConstraint Constraint = new ElementLatencyConstraint(this, predecessor, successor, latency,
		    sysLatency, path);
  ...
  public void addProfile(Profile profile){
    try{
      ...
      // if this is the only profile it is set to active
